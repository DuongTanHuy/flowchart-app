...
export const flowchartOptions = [
  ...
  },
  {
    ...
    script_template:
      'await rpa.F_gotoUrl(`{{{url}}}`,`{{timeout}}`, `{{wait_until}}`);',
    parameters: [
      {
        id: 1,
        key: 'url',
      ...
      },
      {
        ...
        type: 'number',
        label:
          'Thời gian chờ tối đa (đơn vị giây), mặc định 0 là đợi đến khi trang được tải',
        is_required: true,
        default_value: 0,
      },
      {
  ...
  },
  {
    ...
    script_template:
      'await rpa.screenshot(`{{file_name}}`, `{{folder_output}}`)',
    parameters: [
      {
        key: 'file_name',
        type: 'string',
  ...
  },
  {
    ...
    script_template:
      'await rpa.waitForNavigation("{{wait_until}}", `{{timeout}}`)',
    parameters: [
      {
        id: 1,
        key: 'wait_until',
                ...
                option_values: [
                  {
                    ...
                    component: [
                      ...
                      },
                      {
                        ...
                        type: 'checkbox',
                        label:
                          'Trả về giá trị mặc định nếu không tìm thấy thuộc tính',
                        component: [
                          {
  ...
  },
  {
    ...
    description:
      'In ra cửa sổ nhật ký các giá trị ở dạng string, number hay object',
  ...
  },
  {
    ...
    script_template:
      'showLogRunTask("Chạy mã Javascript tùy chỉnh");\r\n{{{js_code}}}',
    parameters: [
      {
        key: 'js_code',
        type: 'script_editor',
