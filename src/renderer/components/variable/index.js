...
function Variables({
  ...
  const updateVariable = (name, event, id) => {
    ...
    if (name === 'jsonValue') {
      ...
      ((event.target.name === 'value' ||
        event.target.name === 'defaultValue') &&
      ...
      if (event.target.value === '' || /^\d+$/.test(event.target.value)) {
        if (event.target.value === '') {
          ...
          _clone[_find].defaultValue[event.target.name][name] = Number(
            event.target.value,
          );
        }
      }
  ...
  const selectFolder = async (event) => {
    if (isElectron()) {
      const _clone = cloneDeep(variables);
      const _find = _clone.findIndex((i) => i.id === itemClicking);
      const path_file = await window.ipcRenderer.invoke(
  ...
  return (
    <>
      <Dialog fullWidth maxWidth="sm" open={open} {...other}>
        <DialogTitle sx={{ paddingBottom: '10px' }}>Variable</DialogTitle>
        <Stack direction="row" alignItems="center" pl={3}>
          ...
          >
            Constants PROFILE_ID, PROFILE_NAME, GROUP_NAME, PROXY_INFO
          </Typography>
        </Stack>
        <DialogContent
          sx={{
              ...
              <Stack sx={styleOptions} spacing={1} width={1} mr={-1}>
                ...
                >
                  ...
                  <Button
                    ...
                    variant="contained"
                    startIcon={
                      <Iconify icon="solar:add-circle-linear" width={20} />
                    }
                ...
                {loading ? (
                  <Stack spacing={1} py={1} width={1}>
                    {[...Array(Math.min(variables?.length || 3, 6))].map(
                      (_, index) => (
                        <Stack
                          key={index}
                          spacing={2}
                              ...
                              {(dragProvided, snapshot) => (
                                ...
                                >
                                  ...
                                  {(() => {
                                    ...
                                    const isInitError =
                                      item?.defaultValue?.init?.min >
                                      item?.defaultValue?.init?.max;
                                    const isMaxError =
        ...
        >
          <IconButton
            ...
            sx={{
              p: 1,
              bgcolor: (theme) =>
                alpha(theme.palette.grey[themeMode === 'dark' ? 700 : 300], 1),
              ...
              '&:hover': {
                bgcolor: (theme) =>
                  alpha(
                    theme.palette.grey[themeMode === 'dark' ? 700 : 300],
                    1,
                  ),
              },
            }}
            ...
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  <Tooltip title="more actions" value-index={item.id}>
                    <IconButton
                      onClick={(event) => {
                        event.stopPropagation();
        ...
        >
          ...
          >
            <Stack direction="row" alignItems="center" spacing={1}>
              <Typography variant="body2">Variable setting</Typography>
              <Tooltip title="Sub title" placement="top">
              ...
              <Stack spacing={2}>
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          updateVariable('is_required', e, item.id)
                        }
                      />
                    }
                ...
                <Stack direction="row" spacing={2}>
                  {!isBooleanType && !isRangeType && (
                    <TextField
                      ...
                      label="Label"
                      onChange={debounce(
                        (e) => updateVariable('label', e, item.id),
                        200,
                      )}
                      size="small"
                      name="label"
                  ...
                  {isNumberType && (
                    <TextField
                      ...
                      label="Default value"
                      onChange={(e) =>
                        updateVariable('defaultValue', e, item.id)
                      }
                      size="small"
                      name="defaultValue"
                  ...
                  {isTextType && (
                    <TextField
                      ...
                      label="Default value"
                      onChange={debounce(
                        (e) => updateVariable('defaultValue', e, item.id),
                        200,
                      )}
                      size="small"
                      name="defaultValue"
                      ...
                      InputProps={{
                        endAdornment: (
                          <InputAdornment position="end">
                            <Tooltip title="more action" value-index={item.id}>
                              <IconButton
                                onClick={(event) => {
                                  event.stopPropagation();
                                  setItemClicking(item.id);
                ...
                {!isBooleanType && !isRangeType ? (
                  <TextField
                    ...
                    label="Description"
                    onChange={debounce(
                      (e) => updateVariable('description', e, item.id),
                      200,
                    )}
                    size="small"
                    name="description"
