...
export default function HandleVariableForm({ formData, IdNode }) {
  ...
  const [conditions, setConditions] = useState(
    formData?.dataFields?.conditions ?? [],
  );
  const [listString, setListString] = useState(
    formData?.dataFields?.strings ?? [],
  );
  ...
  const handleGetAccTitle = useCallback((value, item) => {
    ...
    switch (value) {
      ...
      case 'data_exists':
        return (
          <Typography variant="body2">{`Dữ liệu tồn tại (${item.leftValue})`}</Typography>
        );
  ...
  const handleDeleteCondition = (orConditionId, andConditionId) => {
    ...
    const _findAnd = _cloneOr[_findOr].conditions.findIndex(
      (i) => i.id === andConditionId,
    );
  ...
  const handleUpdateCondition = (orConditionId, andConditionId, data) => {
    ...
    if (
      ['data_exists', 'data_not_exists'].includes(
        _cloneAnd[_findAnd].leftType?.value,
      )
    ) {
      const regexPattern = /^[a-zA-Z_]\w*(\.[a-zA-Z_]\w*)*$/;
      if (
        _cloneAnd[_findAnd].leftValue &&
        !_cloneAnd[_findAnd].leftValue.match(regexPattern)
      ) {
    ...
    <Stack>
      ...
      <Stack spacing={3} mt={2}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField label="Biến chứa dữ liệu" {...params} />
          )}
        ...
        >
          <MenuItem
            ...
            sx={{
              display:
                formData?.dataFields?.data_type !== 'object' ? 'block' : 'none',
            }}
          >
            {formData?.dataFields?.data_type === 'array'
          ...
          {[
            ...
            <MenuItem
              ...
              sx={{
                display:
                  formData?.dataFields?.data_type === 'string'
                    ? 'block'
                    : 'none',
              }}
            >
                ...
                <Fragment key={condition.id}>
                  <Stack spacing={1} overflow="hidden">
                    ...
                    <Typography color="text.secondary" variant="caption">
                      * Sử dụng $&#123;ITEM&#125; để lấy ra giá trị của item để
                      so sánh. <br />* Nếu ITEM là đối tượng bạn có thể truy cập
                      thuộc tính bằng cách sử dụng :
                      $&#123;ITEM.ten_thuoc_tinh&#125;
                    </Typography>
                                  ...
                                  {item.leftType?.value === 'code' ? (
                                    ...
                                    >
                                      <TextField
                                        ...
                                        InputProps={{
                                          endAdornment: item.leftType?.value ===
                                            'value' && (
                                            <PositionedMenu
                    ...
                    <Stack
                      ...
                      sx={{
                        ...
                        position: 'relative',
                        left:
                          condition?.conditions?.length === 1 ? '0px' : '76px',
                      }}
                    >
                      <Button
        ...
        {formData?.dataFields?.method === 'replace' && (
          <>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  checked={formData?.dataFields?.replace_all ?? false}
                />
              }
              onChange={handleChangeNumberSecond}
        ...
        {formData?.dataFields?.method === 'get_property' && (
          <>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  checked={formData?.dataFields?.is_return_default ?? false}
                />
              }
              onChange={handleChangeNumberSecond}
            ...
            {formData?.dataFields?.is_return_default && (
              <>
                ...
                {formData?.dataFields?.default_data_type !== 'number' && (
                  ...
                  >
                    ...
                    <MenuItem
                      ...
                      sx={{
                        display:
                          formData?.dataFields?.default_data_type === 'object'
                            ? 'block'
                            : 'none',
                      }}
                    >
                    ...
                    <MenuItem
                      ...
                      sx={{
                        display:
                          formData?.dataFields?.default_data_type === 'list'
                            ? 'block'
                            : 'none',
                      }}
                    >
                ...
                {['object', 'list'].includes(
                  formData?.dataFields?.default_data_type,
                ) &&
                  formData?.dataFields?.default_value === 'custom' && (
                    <Stack spacing={1}>
                      <Typography
