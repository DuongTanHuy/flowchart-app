...
const AccordionSummary = styled((props) => (
  <MuiAccordionSummary
    expandIcon={<Iconify icon="mingcute:right-line" />}
    {...props}
  />
))(({ theme }) => ({
...
export default function HttpRequestForm({ formData, IdNode }) {
  ...
  const [script, setScript] = useState(
    formData?.dataFields?.json_string_data ?? '',
  );
  ...
  const renderEditor = useCallback(() => <LoadingScreen />, []);
                    ...
                    <TextField
                      ...
                      InputProps={{
                        endAdornment: (
                          <PositionedMenu
                            getVariable={(value) =>
                              getURLParamVariable('value', value, item.id)
                            }
                            openVariableModal={variableModal.onTrue}
                          />
                        ),
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      ...
                      label="Value"
                      onChange={(e) =>
                        updateCustomerHeader('value', e, item.id)
                      }
                      size="small"
                      InputProps={{
                        endAdornment: (
                          <PositionedMenu
                            getVariable={(value) =>
                              getCustomerVariable('value', value, item.id)
                            }
                            openVariableModal={variableModal.onTrue}
                          />
                        ),
          ...
          <>
            ...
            {['text'].includes(dataFields?.content_type) && (
              <TextField
                ...
                onChange={handleChangeNumberSecond}
                value={
                  typeof dataFields?.data === 'object' ? '' : dataFields?.data
                }
                InputProps={{
                  endAdornment: (
                    <PositionedMenu
            ...
            {['form_multipart', 'form_urlencoded'].includes(
              dataFields?.content_type,
            ) && (
              <Accordion slots={{ transition: Fade }} defaultExpanded>
                <AccordionSummary>
                  <Stack
