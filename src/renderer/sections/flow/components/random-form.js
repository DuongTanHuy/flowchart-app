          ...
          <>
            ...
            <Stack direction="row" alignItems="center" spacing={3}>
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.has_upper_case ?? true}
                  />
                }
                onChange={handleChangeNumberSecond}
                label="A-Z"
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.has_lower_case ?? true}
                  />
                }
                onChange={handleChangeNumberSecond}
                label="a-z"
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.has_number ?? true}
                  />
                }
                onChange={handleChangeNumberSecond}
                label="0-9"
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.has_special ?? false}
                  />
                }
                onChange={handleChangeNumberSecond}
