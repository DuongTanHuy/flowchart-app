...
import { FB_PAGE_CATEGORIES } from '../../../utils/constance';
...
const FA_API_OPTIONS = [
  ...
  {
    label:
      'Đăng xuất tài khoản trên các thiết bị khác, trừ thiết bị hiện tại ra',
    ...
    <Stack>
      ...
      <Stack spacing={3} mt={2}>
        <Autocomplete
          ...
          getOptionLabel={(option) =>
            option?.label ??
            FA_API_OPTIONS.find((item) => item.value === option)?.label ??
            option
          }
          ...
          <>
            <Stack direction="row" spacing={3}>
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.is_near_me ?? false}
                  />
                }
                onChange={handleChangeNumberSecond}
                label="Gần tôi"
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={formData?.dataFields?.is_group_public ?? false}
                  />
                }
                onChange={handleChangeNumberSecond}
        ...
        {formData?.dataFields?.api_type === 'createPage' && (
          <>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  checked={formData?.dataFields?.is_random_category ?? false}
                />
              }
              onChange={handleChangeNumberSecond}
            ...
            {!formData?.dataFields?.is_random_category && (
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Danh mục trang" />
                )}
                ...
                <Fragment key={option.id}>
                  <Tooltip
                    title={
                      option?.type === 'list'
                        ? ''
                        : 'Chỉ có thể chọn biến có kiểu danh sách'
                    }
                    arrow
                  ...
                  <Stack className="add-new-element-variable" p={1}>
                    <Button
                      ...
                      startIcon={
                        <Iconify icon="ion:create-outline" width={16} />
                      }
                    >
                      Tạo biến mới
                    </Button>
      ...
      <Variables
        ...
        updateVariableAction={(key) => {
          eventBus.emit('updateNode', {
            data: {
              [isUpdateSelectVariable ? 'friend_ids' : 'variable_name']: key,
            },
            idNode: IdNode,
          });
        }}
