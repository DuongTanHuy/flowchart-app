  ...
  return (
    <Stack spacing={1}>
      ...
      >
        ...
        >
          <Iconify
            icon={showSetting ? 'mingcute:close-fill' : 'uil:setting'}
            color="back"
          />
        </IconButton>
      </Stack>
      {!showSetting ? (
        ...
        <Stack spacing={2}>
          <FormControlLabel
            name="retry"
            control={
              <Checkbox checked={formData?.dataFields?.retry || false} />
            }
