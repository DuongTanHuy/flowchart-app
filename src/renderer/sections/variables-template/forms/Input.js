  ...
  <Stack>
    ...
    <CustomLabel nameLabel="Default Data">
      <TextField
        ...
        onChange={(e) =>
          updateItemByField(template, 'defaultValue', e.target.value)
        }
        // value={value}
        // onChange={onChange}
        inputProps={{
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'showTextCount', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'rightButton', e.target.checked)
            }
          />
        }
      />
