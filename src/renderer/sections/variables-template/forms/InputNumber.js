  ...
  <Stack>
    ...
    <CustomLabel nameLabel="Variables">
      <Autocomplete
        ...
        options={
          variableOptions?.filter((item) => item?.type === 'number') || []
        }
    ...
    <CustomLabel nameLabel="Default Data">
      <TextField
        ...
        onChange={(e) =>
          updateItemByField(template, 'defaultValue', Number(e.target.value))
        }
        inputProps={{
          autoCorrect: 'off',
          spellCheck: 'false',
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'showBordered', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'clearable', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'readOnly', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'showButton', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'isRequired', e.target.checked)
            }
          />
        }
      />
    ...
    <CustomLabel nameLabel="Placeholder">
      <TextField
        ...
        onChange={(e) =>
          updateItemByField(template, 'placeholder', e.target.value)
        }
        inputProps={{
          autoCorrect: 'off',
          spellCheck: 'false',
    ...
    <CustomLabel nameLabel="Max Length">
      <TextField
        ...
        onChange={(e) =>
          updateItemByField(template, 'maxLength', e.target.value)
        }
        inputProps={{
          autoCorrect: 'off',
          spellCheck: 'false',
    ...
    <CustomLabel nameLabel="Min Length">
      <TextField
        ...
        onChange={(e) =>
          updateItemByField(template, 'minLength', e.target.value)
        }
        inputProps={{
          autoCorrect: 'off',
          spellCheck: 'false',
