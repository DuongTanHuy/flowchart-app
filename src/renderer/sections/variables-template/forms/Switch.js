  ...
  <Stack>
    ...
    <CustomLabel nameLabel="Variables">
      <Autocomplete
        ...
        options={
          variableOptions?.filter((item) => item?.type === 'boolean') || []
        }
      ...
      <FormControlLabel
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'defaultValue', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'loading', e.target.checked)
            }
          />
        }
      />
