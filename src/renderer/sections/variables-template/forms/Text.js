      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'customColor', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'strong', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'italic', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'underline', e.target.checked)
            }
          />
        }
      />
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            onChange={(e) =>
              updateItemByField(template, 'delete', e.target.checked)
            }
          />
        }
      />
